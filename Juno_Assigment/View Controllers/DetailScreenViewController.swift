...
class DetailScreenViewController: UIViewController {
    ...
    @IBOutlet private weak var leftBarButtonCoinLogoImageView: UIBarButtonItem!
    ...
    var yourHolding: YourCryptoHoldings? {
        didSet{
            ...
            DispatchQueue.main.async {
                ...
                self.leftBarButtonCoinLogoImageView.setBackgroundImage(nameSvgImage.uiImage, for: .normal, style: .plain, barMetrics: .default)
...
// function to setup initial ui of detail screen
    private func setUpUI() {
        ...
        let data = try? Data(contentsOf: svgImage!)
        let nameSvgImage: SVGKImage = SVGKImage(data: data)
        self.leftBarButtonCoinLogoImageView.image = nameSvgImage.uiImage
